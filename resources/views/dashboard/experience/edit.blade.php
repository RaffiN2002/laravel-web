...
@section('content')
    ...
    <form action="{{route('experience.update',$data->id)}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control form-control-sm" name="title" id="title" aria-describedby="helpId" placeholder="Add Position" value="{{$data->title}}">
        </div>
        <div class="mb-3">
            <label for="info1" class="form-label">Company Name</label>
            <input type="text"
              class="form-control form-control-sm" name="info1" id="info1" aria-describedby="helpId" placeholder="Add Company Name" value="{{$data->info1}}">
          </div>
        <div class="mb-3">
            <div class="row">
